...
public class Lec07ConnectionManagerTest2 {
	@Autowired
	...
	/**
	 * []
	 * math event connection setup
	 * connection setup ClientConnectionRequest(clientId=order-service, secretKey=asdf)
	 * ComputationRequestDto(input=5)
	 * ComputationRequestDto(input=5)
	 * [org.springframework.messaging.rsocket.DefaultRSocketRequester@7619f18b]
	 * [org.springframework.messaging.rsocket.DefaultRSocketRequester@7619f18b]
	 * [org.springframework.messaging.rsocket.DefaultRSocketRequester@7619f18b]
	 * [org.springframework.messaging.rsocket.DefaultRSocketRequester@7619f18b]
	 * [org.springframework.messaging.rsocket.DefaultRSocketRequester@7619f18b]
	 * finally closed <- only one
	 */
